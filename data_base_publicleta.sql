...
CREATE TABLE `accident` (
  ...
  `accidedent_lat` varchar(45) NOT NULL,
  `accident_lon` varchar(45) NOT NULL,
  `accident_date` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  `accident_description` varchar(280) NOT NULL,
  `usr_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`accident_id`),
  KEY `fk_accident_1_idx` (`usr_id`),
  CONSTRAINT `user_id` FOREIGN KEY (`usr_id`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bike` (
  `id_bike` varchar(45) NOT NULL,
  `bike_color` varchar(45) NOT NULL,
  `bike_type` varchar(45) NOT NULL,
  `bike_brand` varchar(45) DEFAULT NULL,
  `id_user` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_bike`),
  KEY `fk_bike_1_idx` (`id_user`),
  CONSTRAINT `bike_user` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `stole`
--
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stole` (
  `stole_id` int(11) NOT NULL,
  `stole_lon` varchar(45) NOT NULL,
  `stole_lat` varchar(45) NOT NULL,
  `stole_date` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  `stole_desc` varchar(280) NOT NULL,
  PRIMARY KEY (`stole_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stole`
--

LOCK TABLES `stole` WRITE;
/*!40000 ALTER TABLE `stole` DISABLE KEYS */;
/*!40000 ALTER TABLE `stole` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2018-09-15 14:00:58',NULL),('diagnostics.include_raw','OFF','2018-09-15 14:00:58',NULL),('ps_thread_trx_info.max_length','65535','2018-09-15 14:00:58',NULL),('statement_performance_analyzer.limit','100','2018-09-15 14:00:58',NULL),('statement_performance_analyzer.view',NULL,'2018-09-15 14:00:58',NULL),('statement_truncate_len','64','2018-09-15 14:00:58',NULL);
...
-- Dump completed on 2018-09-15 18:44:09
